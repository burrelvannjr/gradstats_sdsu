...
* [**Installing R/RStudio**](Intro-and-Univariate-Statistics.html)
...
1. Next, we will download [**RStudio**](https://www.rstudio.com/products/rstudio/download2/) which is a easily understandable user interface for using R. Under "Installers for Supported Platforms" select the RStudio installer that matches your operating system.
...
```{r}
bwplot(~mpg | factor(cyl), data = data1, pch="|", main = "Bar-and-Whisker Plot of 'mpg' by 'Cylinder'")
```
