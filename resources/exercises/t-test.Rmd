...
* [**t-Test**](t-test.html) [[*t-Test example*]](t-test-example.html) [[*R Script*]](t-test.R)
...
```{r}
hst(data1, mpg, am)
#can add call: main = "Histogram of 'Miles per Gallon' by 'Manual Transmission Type'"
```
...
```{r}
box(data1, mpg, am)
# can add main = "Bar-and-Whisker Plot of 'mpg' by 'Manual Transmission Type'"
```
