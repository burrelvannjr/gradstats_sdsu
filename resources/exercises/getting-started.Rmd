...
While this is great, and the data set is loaded into your console window, you will need a local copy to run operations on. To create a local copy (an object) so that you can run manipulations on the <span style="color:blue">`mtcars`</span> data, you should create a new object, like this:
...
[Dr. Matt Blackwell's Advanced Quant Methods Course in Political Science](https://gov2002.mattblackwell.org/materials/) <br>
[Dr. Chris Bail's Data & Society Course](https://dssoc.github.io/schedule/) <br>
Summer Institute in Computational Social Science - [ [Github Repo of 2020 Materials](https://github.com/compsocialscience/summer-institute/tree/master/2020/materials), [2019 Materials](https://sicss.io/2019/princeton/schedule), [2020  Videos (with Links)](https://www.youtube.com/watch?v=zGG9wPl1C5E&list=PL9UNgBC7ODr4M1_4RLr4IYcXbHPUWYMrZ) ]<br>
