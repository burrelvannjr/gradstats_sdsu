...
Sometimes you'll want to use a CSV file from a website, where you have a direct link to the CSV. For example, I uploaded the same `mtcars` data set as `cars.csv` on **<a href="www.burrelvannjr.com/cars.csv" target="_blank"><i>my website</i></a>**. 
