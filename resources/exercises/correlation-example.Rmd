...
```{r}
hst(data, jealousy)
#main = "Histogram of 'Jealousy Score'"
```

```{r}
hst(data, esteem)
#main = "Histogram of 'Self-Esteem Score'"
```
...
```{r}
box(data, jealousy)
#main = "Bar-and-Whisker Plot of 'Jealousy Score'"
```

```{r}
box(data, esteem)
#main = "Bar-and-Whisker Plot of 'Self-Esteem Score'"
```
...
```{r}
qq(data, jealousy)
#main = "Normal Q-Q Plot of 'Jealousy Score'", xlab = "Expected Normal"
```

```{r}
qq(data, esteem)
#main = "Normal Q-Q Plot of 'Self-Esteem Score'", xlab = "Expected Normal"
```
