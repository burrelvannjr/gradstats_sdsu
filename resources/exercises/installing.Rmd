...
```{r, echo=FALSE}
oss <- c("macOS 10+","macOS 11+")
downloads <- c("download","download")
urls <- c("https://s3.amazonaws.com/rstudio-ide-build/desktop/macos/RStudio-2022.07.2-576.dmg","https://s3.amazonaws.com/rstudio-ide-build/electron/macos/RStudio-2022.12.0-353.dmg")
